...
public class ArraysIntro {
    public static void main(String[] args) {
        ...
        //Looping through each element in the array and printing them one by one using for i loop
        ...
        //Sorting the array using Arrays.sort() method - it sorts in ascending order for primitives
        // (lexicographically for object)
        Arrays.sort(numbers);
